...
export const courses: Course[] = [
  ...
  },
  {
    ...
    price: choirAcademySchoolYearPricing.summary.primary,
    pricing: choirAcademySchoolYearPricing,
    learningGoals: ["Goede zangbasis opbouwen", "Samen zingen met meer zelfstandigheid", "Muzikaliteit en luistervaardigheid verdiepen", "Zelfvertrouwen op het podium ontwikkelen"],
    ...
    sessions: [
      ...
      },
      {
        ...
        label: "Vrijdag",
        dayAndTime: "Vrijdag, 15:45-16:30",
        startDate: [new Date('September 5, 2025')],
        location: "Brede School West, Zijderupsvlinderlaan 8, 4105 TC Culemborg",
        signUpLink: "https://docs.google.com/forms/d/e/1FAIpQLSeTPwe1944dDA8TyBWpU_i_nUR7UyiZ6BekuHVNUYGoM6NfzQ/viewform?usp=header",
      },
  ...
  },
  {
    ...
    price: choirAcademySchoolYearPricing.summary.primary,
    pricing: choirAcademySchoolYearPricing,
    learningGoals: ["Meer uitdaging in samenzang", "Muzikale presentatie versterken", "Meerstemmig zingen", "Ensembleklank en podiumpresence verfijnen"],
  ...
  },
  {
    ...
    price: choirAcademySchoolYearPricing.summary.primary,
    pricing: choirAcademySchoolYearPricing,
    learningGoals: ["Met meer diepgang zingen en performen", "Ensemblezang op niveau", "Expressie en muzikaal eigenaarschap ontwikkelen", "Zelfstandig werken aan repertoire en presentatie"],
