...
export default function ChoirAcademy() {
  ...
  return( 
    <div className="py-8">
      ...
      <p className="text-xl leading-8 text-gray-600 text-center pt-4">Zing mee!</p>
      <p className="mx-auto max-w-2xl rounded-md py-8 text-center">
        Woon je in Culemborg of omgeving en wil je graag je <b>zangstem</b>, <b>muzikaliteit</b> en <b>podiumpresentatie</b> verbeteren? Meld je aan voor de Choir Academy!
      </p>
      <p className="mx-auto max-w-2xl rounded-md text-center">
        Op de academy leer je niet alleen heel veel liedjes, we besteden ook aandacht aan hoe je je stem gezond gebruikt en hoe je comfortabel op een podium staat. 
        Daarnaast besteden we ook aandacht aan ritmegevoel, expressie, interpretatie en bladmuziek, zodat jij je muzikaliteit nog verder kan ontwikkelen.
      </p>
