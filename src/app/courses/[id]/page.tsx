...
export default function CoursePage({ params }: { params: { id: string}}) {
  ...
  return (
    <>
      <a href='/courses' className="text-lg font-semibold leading-6 text-gray-900 flex gap-1 z-10 absolute top-4 left-8">
        <ArrowLeftIcon width={16} />  Terug naar overzicht
      </a>
          ...
          <div className="lg:col-span-8 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl">
            <div>
              ...
              { course.signUp ? 
                ...
                <p className="pt-16">
                  Voor deze cursus kan je niet niet (meer) opgeven. Toch interesse? Stuur een mailtje naar 
                  <a href="mailto:info@mimimagusin.com" className="pl-1 font-semibold italic">info@mimimagusin.com</a>.
                </p> }
