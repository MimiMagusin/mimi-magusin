  ...
  return (
    <>
      <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
        ...
        <p className="mt-16">Het zou zonde zijn als geld een belemmering is je muzikaliteit te ontwikkelen. Is geld een probleem? Stuur even een mail!</p>
      </div>
      <div className="lg:col-span-8 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl pt-8 flex">
        <p>
          ...
          <span>
           Aanmelden? Stuur een mail naar</span>
